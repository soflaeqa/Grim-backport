...
public final class BackendRegistryImpl implements BackendRegistry {
    ...
    private final ConcurrentHashMap<String, BackendProvider> providers = new ConcurrentHashMap<String, BackendProvider>();
    ...
    public @NotNull Set<@NotNull String> registeredIds() {
        return Collections.unmodifiableSet(new LinkedHashSet<String>(providers.keySet()));
    }
}
