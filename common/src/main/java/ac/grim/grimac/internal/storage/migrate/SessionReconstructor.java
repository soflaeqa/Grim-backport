...
public final class SessionReconstructor {
    ...
    public static final class ReconstructedViolation {
        ...
        public ReconstructedViolation(long legacyId, UUID sessionId, UUID playerUuid, int checkId,
                                      double vl, long occurredEpochMs, String verbose) {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof ReconstructedViolation)) return false;
            ReconstructedViolation that = (ReconstructedViolation) o;
            return legacyId == that.legacyId
                    && checkId == that.checkId
                    && Double.compare(that.vl, vl) == 0
                    && occurredEpochMs == that.occurredEpochMs
        ...
        @Override
        public int hashCode() {
            return Objects.hash(legacyId, sessionId, playerUuid, checkId, vl, occurredEpochMs, verbose);
        }

        @Override
        public String toString() {
            return "ReconstructedViolation["
                    + "legacyId=" + legacyId
                    + ", sessionId=" + sessionId
    ...
    public void accept(V0Reader.V0Violation v) {
        ...
        if (currentSession == null
            ...
            currentSession = new SessionRecord(
                    ...
                    currentSession.closedAtEpochMs(),
    ...
    private void flushSession() {
        emit.onSessionBoundary(currentSession, Collections.unmodifiableList(new ArrayList<ReconstructedViolation>(pendingInSession)));
