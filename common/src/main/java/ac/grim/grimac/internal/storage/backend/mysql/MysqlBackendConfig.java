...
@ApiStatus.Internal
public final class MysqlBackendConfig implements BackendConfig {
    ...
    public MysqlBackendConfig(@NotNull String host,
                              int port,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MysqlBackendConfig)) return false;
        MysqlBackendConfig that = (MysqlBackendConfig) o;
