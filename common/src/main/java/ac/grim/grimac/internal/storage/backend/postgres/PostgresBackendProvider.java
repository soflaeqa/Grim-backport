...
public final class PostgresBackendProvider implements BackendProvider {
    ...
    @Override public @NotNull Class<? extends BackendConfig> configType() { return PostgresBackendConfig.class; }
    @Override public @NotNull BackendConfig readConfig(@NotNull BackendConfigSource src) {
        ...
        return new PostgresBackendConfig(
                src.getString("host", "localhost"), src.getInt("port", 5432),
                src.getString("database", "grim"), src.getString("user", "postgres"),
